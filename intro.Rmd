...
ggplot(tabla2) + geom_tile(aes(x=aduana, y=pais_procedencia, fill=Freq))+ theme(axis.text.x = element_text(angle = 90, vjust=0.5, size = 8))+scale_fill_gradient(low="white",high="blue")+labs(x="Pais de procedencia",y="Aduana")
```
